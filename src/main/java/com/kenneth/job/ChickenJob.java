 ...
 */
public class ChickenJob extends BasicTask{
    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(ChickenJob.class);
    ...
    protected QuartzInfo getQuartzInfo() {
        ...
        QuartzInfo findByCode = quartzInfoService.findByCode("ChickenJob");
        return findByCode;
    }
    @Override
