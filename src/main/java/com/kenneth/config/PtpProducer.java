...
public class PtpProducer {
     ...
     */
    public void send(){
//        jmsQueueTemplate.setTimeToLive(3000);
        jmsQueueTemplate.send(JmsConstant.QUEUE_NAME, session -> {
...
//        throw new RuntimeException();
    ...
    public void convertAndSend(){
        jmsQueueTemplate.convertAndSend(JmsConstant.QUEUE_NAME, "我是自动转换的消息");
//        throw new RuntimeException();  
    }
}
